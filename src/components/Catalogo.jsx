...
const Catalogo = (props) => {
  ...
  return (
    <div className="container px-8 lg:px-10 bg-gradient-to-t from-[#fbc2eb] to-[#a6c1ee] pt-24 pb-8 gap-4">
      ...
      <div className="md:grid md:grid-cols-2 lg:grid-cols-4 md:gap-x-5">
        {Items.map((item, key) => (
          <li
            key={key}
            className="text-m lg:text-sm lg:my-0 my-7 lg:font-normal list-none"
          >
            <div className="mx-auto w-full max-w-sm rounded-lg bg-white p-2 ">
              <div className="">
                <a
                  href="/#"
                  className="relative inline-block w-full transform transition-transform duration-300 ease-in-out"
                >
                  <div className="relative flex h-50 justify-center overflow-hidden rounded-lg">
                    ...
                    <div className="mt-4 grid grid-cols-2">
                      <div className="flex items-center">
                        <div className="relative">
                          <h2
                            className="line-clamp-1 text-base font-medium text-gray-800 md:text-lg hover:underline"
                            title="New York"
                          >
                            Statue of Liberty
                          </h2>
                ...
                <div className="mt-2 grid grid-cols-2 grid-rows-2 gap-4 border-b border-t border-gray-200 pb-3 pt-3">
                  <p className="flex items-center text-gray-800 xl:flex-row xl:items-center">
                    ...
                    <span className="xl:mt-0"> Condominium </span>
                  </p>
                  <p className="flex items-center text-gray-800 xl:flex-row xl:items-center">
                    <svg
                      className="mr-3 inline-block h-5 w-5 fill-current text-gray-800 xl:h-4 xl:w-4"
                    ...
                    <span className="mt-0"> Partly furnished </span>
                  </p>
                  <p className="flex items-center text-gray-800 xl:flex-row xl:items-center">
                    <svg
                      className="mr-3 inline-block h-5 w-5 fill-current text-gray-800 xl:h-4 xl:w-4"
                    ...
                    <span className="mt-0"> 1,386 sq. ft. </span>
                  </p>
                  <p className="flex items-center text-gray-800 xl:flex-row xl:items-center">
                    <svg
                      className="mr-3 inline-block h-5 w-5 fill-current text-gray-800 xl:h-4 xl:w-4"
                    ...
                    <span className="mt-0"> $1.98 /sq.ft </span>
                  </p>
                </div>
              </div>
            </div>
