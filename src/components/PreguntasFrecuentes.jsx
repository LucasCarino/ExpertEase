    ...
    return (
        <section>
            ...
            <div className = "bg-gradient-to-t from-[#fbc2eb] to-[#a6c1ee] w-full relative object-center object-fit z-0">
                <div class="relative flex flex-col items-center justify-center sm:px-0 z-20 pb-20">
                    ...
                    <div class="lg:w-1/2 md:w-8/12 sm:w-9/12 w-full">
                        <div class="bg-white shadow rounded p-8">
                            <div class="flex items-center justify-between">
                                <div>
                                    <h2 class="text-base font-semibold leading-none text-gray-800">¿Por qué deberías utilizar ExpertEase?</h2>
                                </div>
                            ...
                            {box1 && (
                                <ul class="">
                                    <li>
                                        <p class="text-base leading-normal text-gray-600 pt-3">Porque somos la plataforma n° 1 de clases en línea. </p>
                                    </li>
                                </ul>
                            )}
                        </div>
                        <div class="bg-white shadow rounded p-8 mt-8">
                            <div class="flex items-center justify-between">
                                <div>
                                    <h2 class="text-base font-semibold leading-none text-gray-800">¿Qué método de pago puedo usar?</h2>
                                </div>
                                <button
                                    onClick={() => {
                                        setBox2(!box2);
                            ...
                            {box2 && (
                                <ul>
                                    <li>
                                        <p class="text-base leading-normal text-gray-600 pt-3">Puedes usar Paypal, Visa, Payoneer, Master Card, Tarjeta de Débito, Mercado Pago, Pago Fácil.</p>
                                    </li>
                                </ul>
                            )}
                        </div>
                        <div class="bg-white shadow rounded p-8 mt-8">
                            <div class="flex items-center justify-between">
                                <div>
                                    <h2 class="text-base font-semibold leading-none text-gray-800">¿Qué tipo de clases puedo tomar?</h2>
                                </div>
                                <button
                                    onClick={() => {
                                        setBox3(!box3);
                            ...
                            {box3 && (
                                <ul>
                                    <li>
                                        <p class="text-base leading-normal text-gray-600 pt-3">¡Todo tipo de clases! Desde clases de música, matemática, álgebra, programación, cocina, hasta clases de adiestramiento canino.</p>
                                    </li>
                                </ul>
                            )}
                        </div>
                        <div class="bg-white shadow rounded p-8 mt-8">
                            <div class="flex items-center justify-between">
                                <div>
                                    <h2 class="text-base font-semibold leading-none text-gray-800">¿Cómo puedo recuperar la contraseña?</h2>
                                </div>
                            ...
                            {box4 && (
                                <ul>
                                    <li>
                                        <p class="text-base leading-normal text-gray-600 pt-3">Por medio del botón "¿Olvidaste tu contraseña? de la página de ingreso.</p>
                                    </li>
                                </ul>
                            )}
                        </div>
